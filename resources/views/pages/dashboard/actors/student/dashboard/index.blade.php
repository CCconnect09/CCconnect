            ...
            <section class="row">
                    ...
                    <div class="row user-select-none">
                        <div class="col-6 col-lg-3 col-md-6">
                            <a style="cursor: pointer" onclick="window.location.href='/dashboard/confessions'"
                                data-bs-toggle="tooltip" data-bs-original-title="The total number of confessions you have made.">
                                <div class="card">
                        ...
                        <div class="col-6 col-lg-3 col-md-6">
                            <a style="cursor: pointer" onclick="window.location.href='/dashboard/confessions/responses'"
                                ...
                                data-bs-original-title="The number of responses made by 'officers' to your confessions (system's responses included).">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            <div
                        ...
                        <div class="col-6 col-lg-3 col-md-6">
                            <a style="cursor: pointer" onclick="window.location.href='/dashboard/confessions/comments'"
                                data-bs-toggle="tooltip"
                                data-bs-original-title="The number of comments you have made on all confessions.">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            <div
                        ...
                        <div class="col-6 col-lg-3 col-md-6">
                            <a tabindex="1" id="log-in-tag" style="cursor: pointer" data-bs-toggle="tooltip"
                                data-bs-original-title="The number of log-in history entries you have.">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            <div
                ...
                <div class="col-12 col-lg-3">
                    <div class="card" style="overflow-x:auto">
                        <div class="card-header">
                            <h4 class="text-center">Your Recent Confessions</h4>
                        </div>
                            ...
                            @empty
                                <div class="recent-message px-4 py-3">
                                    <div class="alert alert-warning" role="alert">
                                        <h4 class="alert-heading">No confessions :(</h4>
                                    </div>
                                </div>
                            @endforelse
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            @empty
                                <div class="alert alert-warning" role="alert">
                                    ...
                                    <p>There are no responses from the related parties yet.</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
