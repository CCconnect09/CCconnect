            ...
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">
                        Details of the confession you made.
                    </p>
                    <hr>
                    <div class="mb-4">
                        <a href="{{ back()->getTargetUrl() }}" data-bs-toggle="tooltip"
                            data-bs-original-title="Back to the previous page."
                        ...
                        @if ($confession->status === 'unprocess')
                            <a data-bs-toggle="tooltip"
                                data-bs-original-title="Edit your confession."
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="/dashboard/confessions">Confessions</a>
                            </li>
        ...
        <section class="section">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title d-inline-block">Confession</h3> <small
                ...
                <div class="card-body">
                    ...
                    <div class="d-md-flex justify-content-center">
                        <div class="me-4">
                            <p>
                                <span class="fw-bold">Date:</span> {{ $confession->date }}
                            </p>
                            <p>
                                <span class="fw-bold">Place of Incident:</span>
                        ...
                        <div class="me-4">
                            <p>
                                <span class="fw-bold">Category:</span> {{ $confession->category->category_name }}
                            </p>
                            <p>
                            ...
                            <p>
                                <span class="fw-bold me-1">Edited:</span>
            ...
            @if ($confession->status === 'unprocess' || $confession->status === 'process')
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Provide a Response</h3>
                    </div>
                ...
                <div class="card-body">
                                        ...
                                        <div class="text-start pe-4">
                                            ...
                                            @if (
                                                ...
                                                <div
                                                    ...
                                                    <div class="btn-group">
                                                        <div class="me-2">
                                                            <a data-bs-original-title="Edit your response."
                                                        ...
                                                        <div class="me-2">
                                                            <a data-bs-toggle="tooltip"
                                                                data-bs-original-title="Unsend your response."
                                            ...
                                            <div class="attachment-file position-relative">
                                                ...
                                                @if ($response->id_user === $userData->id_user && $confession->status === 'unprocess')
                                                    <a class="btn btn-danger px-2 pt-2 position-absolute"
                                                        data-bs-toggle="tooltip"
                                                        data-bs-original-title="Unsend your supporting file."
                    ...
                    @empty
                        <div class="alert alert-warning" role="alert">
                            <h4 class="alert-heading">No responses :(</h4>
                            <p>No responses from the related parties yet.</p>
                        </div>
                    @endforelse
                </div>
            </div>
