            ...
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <div class="mb-4">
                        ...
                        <a data-bs-toggle="tooltip" data-bs-original-title="Unsend the response you gave."
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="/dashboard/confessions/responses">Responses</a>
                            </li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title d-inline-block">Response</h3>
                        </div>
                                        ...
                                        <div class="mb-4">
                                            <div class="attachment-file">
                                                <a class="btn btn-danger px-2 pt-2 position-absolute"
                                                    ...
                                                    data-bs-original-title="Unsend the supporting file you have given."
