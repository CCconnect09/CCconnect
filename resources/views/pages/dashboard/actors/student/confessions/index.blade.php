        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h2>All Your Confessions</h2>
                    <p class="text-subtitle text-muted">
                        Complete data of your confessions.
                    </p>
                    <hr>
                    <div class="mb-4">
                        <a data-bs-toggle="tooltip"
                            data-bs-original-title="Create a confession you want to share."
                            href="/dashboard/confessions/create" class="btn btn-success px-2 pt-2 me-1">
                            <span class="fa-fw fa-lg select-all fas text-white"></span> Create Confession
                        </a>
                    </div>
                </div>
                    ...
                    <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            @if ($confession->status === 'unprocess')
                                                ...
                                                <div class="me-2">
                                                    <a data-bs-toggle="tooltip"
                                                        data-bs-original-title="Unsend your confession."
                                            ...
                                            <div class="me-2">
                                                <a data-bs-toggle="tooltip"
                                                    data-bs-original-title="Details of your confession."
                            ...
                            @empty
                                <tr>
                                    <td colspan="8">
                                        <p class="text-center mt-3">No confessions yet :(</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
