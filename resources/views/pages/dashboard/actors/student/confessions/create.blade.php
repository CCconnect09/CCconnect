                                            ...
                                            <div
                                                ...
                                                <div class="position-relative">
                                                    <input autofocus type="text" class="form-control py-2"
                                                        placeholder="e.g. I got bullied..." id="title" name="title"
                                                        value="{{ old('title') }}" />
                                            ...
                                            <div
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control py-2"
                                                        placeholder="e.g. i-got-bullied" id="slug" name="slug"
                                            ...
                                            <div
                                                ...
                                                <div class="position-relative">
                                                    <input type="date" class="form-control py-2"
                                                        placeholder="e.g. Date of incident" id="date" name="date"
