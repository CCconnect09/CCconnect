            ...
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">
                        Set up some of the account information you have.
                    </p>
                    <hr>
                    <div class="mb-4">
                        ...
                        <div class="row">
                                ...
                                <div
                                    ...
                                    <div class="position-relative">
                                        <input readonly disabled type="text" class="form-control py-2"
                                            placeholder="e.g. John Doe" id="full_name" name="full_name"
                            ...
                            <div class="col-md-6 col-12 mb-1">
                                <div class="form-group has-icon-left mandatory @error('nik'){{ 'is-invalid' }}@enderror">
                                    <label for="nik" class="form-label">National ID (NIK)</label>
                                    <div class="position-relative">
                                        <input readonly disabled type="text" class="form-control py-2"
                            ...
                            <div class="col-md-6 col-12 mb-1">
                                <div
                                    ...
                                    <div class="position-relative">
                                        <input type="text" class="form-control py-2" placeholder="e.g. johndoe"
                                ...
                                <div
                                    ...
                                    <div class="position-relative">
                                        <input type="email" class="form-control py-2"
                                            placeholder="e.g. johndoe@gmail.com" id="email" name="email"
                        ...
                        <div class="row">
                            <div class="col-12 mb-1">
                                <div class="form-group has-icon-left mandatory @error('nisn'){{ 'is-invalid' }}@enderror">
                                    <label for="nisn" class="form-label">Student ID (NISN)</label>
                                    <div class="position-relative">
                                        <input readonly disabled type="text" class="form-control py-2"
                        ...
                        <div class="row">
                            <div class="col-12 mb-1">
                                <div class="form-group">
                                    <label
                                        class="@if ($userData->profile_picture) {{ 'd-block' }} @endif{{ 'form-label' }} @error('profile_picture'){{ 'text-danger' }}@enderror">Profile Picture</label>
                                    <div class="position-relative">
                                        {{-- Image preview --}}
                                        @if ($isUserImageExist($userData->profile_picture))
                                            <div class="mb-2">
                                                <a data-bs-toggle="tooltip"
                                                    data-bs-original-title="Delete your profile picture."
