        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h2>Settings</h2>
                    <p class="text-subtitle text-muted">Perform setup on some of the account data that you have.</p>
                    <hr>
                    <div class="mb-4">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="/dashboard/users/account">Profile</a>
                            </li>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12 mb-1">
                                <div
                                    ...
                                    <label for="full_name" class="form-label">No</label>
                                    <div class="position-relative">
                                        <input type="text" class="form-control py-2" placeholder="Samuel Drian"
                            ...
                            <div class="col-md-6 col-12 mb-1">
                                <div class="form-group has-icon-left mandatory @error('nik'){{ 'is-invalid' }}@enderror">
                                    <label for="nik" class="form-label">Student ID</label>
                                    <div class="position-relative">
                                        <input type="text" class="form-control py-2" placeholder="e.g. 212131"
                            ...
                            <div class="col-md-6 col-12 mb-1">
                                <div
                                    ...
                                    <div class="position-relative">
                                        <input type="text" class="form-control py-2" placeholder="e.g. Drian"
                                ...
                                <div
                                    ...
                                    <div class="position-relative">
                                        <input type="email" class="form-control py-2"
                                            placeholder="e.g. Driancabaylo@gmail.com" id="email" name="email"
                        ...
                        <div class="row">
                            <div class="col-12 mb-1">
                                <div class="form-group">
                                    <label
                                        class="@if ($userData->profile_picture) {{ 'd-block' }} @endif{{ 'form-label' }} @error('profile_picture'){{ 'text-danger' }}@enderror">
                                        Photo</label>
                                    <div class="position-relative">
                                        {{-- Image preview --}}
                                        @if ($isUserImageExist($userData->profile_picture))
                                            <div class="mb-2">
                                                <a data-bs-toggle="tooltip"
                                                    data-bs-original-title="Delete your profile photo."
