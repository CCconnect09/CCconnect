        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h2>Create an Application Guide</h2>
                    <p class="text-subtitle text-muted">Provide a good application guide so that users can understand how this application work.
                    </p>
                    <hr>
                    <div class="mb-4">
                        <a href="{{ back()->getTargetUrl() }}" data-bs-toggle="tooltip"
                            ...
                            <span class="fa-fw fa-lg select-all fas text-white"></span>Return
                        </a>
                    </div>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="/dashboard/setting/guides">Guide</a>
                            </li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Application Guide</h3>
                        </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div
                                                ...
                                                <div class="position-relative">
                                                    <input autofocus type="text" class="form-control py-2"
                                                        placeholder="e.g. Recommendation" id="nav_title" name="nav_title"
                                                        value="{{ old('nav_title') }}" />
                                        ...
                                        <div class="col-md-6 col-12 mb-1">
                                            <div
                                                ...
                                                <div class="position-relative">
                                                    <input autofocus type="text" class="form-control py-2"
                                                        placeholder="e.g. Here are recommendations..." id="title"
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="form-check me-3">
                                                            ...
                                                            <label data-bs-toggle="tooltip"
                                                                data-bs-original-title="This status will create a guide without Children."
                                                                class="form-check-label form-label" for="status-single">
                                                                Without Child (single)
                                                            </label>
                                                        </div>
                                                        <div class="form-check me-3">
                                                            <input class="form-check-input" type="radio" name="status"
                                                            ...
                                                            <label data-bs-toggle="tooltip"
                                                                data-bs-original-title="This status will make the guide have children."
                                    ...
                                    <div class="row">
                                        <div class="col-12 mb-1">
                                            <div class="form-group mandatory @error('body'){{ 'is-invalid' }}@enderror">
                                                <div class="position-relative">
                                                    <label class="form-label">Fill out the Application Guide</label>
