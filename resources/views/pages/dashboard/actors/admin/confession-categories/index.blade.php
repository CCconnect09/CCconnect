        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h2>All Recognition Categories</h2>
                    <p class="text-subtitle text-muted">
                        Overall data from categories for recognition.
                    </p>
                    <hr>
                    <div class="mb-4">
                        <a data-bs-toggle="tooltip" data-bs-original-title="Create a category for a confession."
                            href="/dashboard/confessions/confession-categories/create"
                            class="btn btn-success px-2 pt-2 me-1">
                            <span class="fa-fw fa-lg select-all fas text-white"></span> Create a Category
                        </a>
                    </div>
                </div>
                    ...
                    <table class="table table-striped" id="table1">
                        <thead>
                            <tr>
                                ...
                                <th>Category Name</th>
                                <th>Description</th>
                                <th>Number of Acknowledgments</th>
                                <th>Edit</th>
                                <th>Image</th>
                                <th>Data</th>
                                <th>Action</th>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            @if ($category->flag_active === 'Y')
                                                <div class="me-2">
                                                    <a data-bs-toggle="tooltip"
                                                        data-bs-original-title="Make edit to the recognition category."
                                                ...
                                                <div class="me-2">
                                                    <a data-bs-toggle="tooltip"
                                                        data-bs-original-title="Disable recognition category."
                                            ...
                                            @else
                                                <div class="me-2">
                                                    <a data-bs-toggle="tooltip"
                                                        data-bs-original-title="Activation of recognition categories."
