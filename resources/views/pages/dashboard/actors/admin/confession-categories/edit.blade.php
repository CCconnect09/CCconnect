            ...
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <div class="mb-4">
                        ...
                        <a data-bs-toggle="tooltip" data-bs-original-title="Disable recognition category." href="#"
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="/dashboard/confessions/confession-categories">Category</a>
                            </li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12 mb-1">
                                            <div
                                                ...
                                                <label for="category_name" class="form-label">No</label>
                                                <div class="position-relative">
                                                    <input type="text" class="form-control py-2"
                                                        placeholder="e.g. Bullying" id="category_name" name="category_name"
                                        ...
                                        <div class="col-md-6 col-12 mb-1">
                                            <div
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control py-2"
                                                        placeholder="e.g. Sexual harassment" id="slug" name="slug"
                                    ...
                                    <div class="row">
                                        <div class="col-12 mb-1">
                                            <div class="form-group">
                                                <div class="position-relative">
                                                    <label for="image"
                                                        class="@if ($confessionCategory->image) {{ 'd-block' }} @endif{{ 'form-label' }} @error('image'){{ 'text-danger' }}@enderror">Image</label>

                                                    {{-- Image preview --}}
                                                    @if ($confessionCategory->image)
                                                        <div class="mb-2">
                                                            <a data-bs-toggle="tooltip"
                                                                data-bs-original-title="Delete confession category imagess."
