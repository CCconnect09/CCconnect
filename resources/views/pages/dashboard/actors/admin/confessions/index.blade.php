            ...
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">
                        All data from acknowledgments with status unprocess, process, release, and close.
                    </p>
                    <hr>
                </div>
                    ...
                    <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                                        ...
                                        <div class="d-flex">
                                            <div class="me-2">
                                                <a data-bs-toggle="tooltip"
                                                    data-bs-original-title="Details of complaints."
                            ...
                            @empty
                                <tr>
                                    <td colspan="9">
                                        <p class="text-center mt-3">No acknowledgment</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <div class="me-2">
                                                <a data-bs-toggle="tooltip"
                                                    data-bs-original-title="Details of Complaint."
                                                    href="/dashboard/confessions/{{ $confession->slug }}/responses/create"
                                                    class="btn btn-info px-2 pt-2">
                                                    <span class="fa-fw fa-lg select-all fas"></span>
                                                </a>
