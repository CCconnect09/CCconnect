        ...
        <div class="page-content mt-4">
            <section class="row">
                    ...
                    <div class="row user-select-none">
                        <div class="col-6 col-lg-3 col-md-6">
                            <a style="cursor: pointer" onclick="window.location.href='/dashboard/users'"
                                ...
                                data-bs-original-title="The number of users who have registered on the website {{ config('web_config')['TEXT_WEB_TITLE'] }}.">
                                <div class="card">
                        ...
                        <div class="col-6 col-lg-3 col-md-6">
                            <a style="cursor: pointer" onclick="window.location.href='/dashboard/users?data=non-active'"
                                data-bs-toggle="tooltip" data-bs-original-title="Number of users who have been inactive.">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            <div
                        ...
                        <div class="col-6 col-lg-3 col-md-6">
                            <a style="cursor: pointer" onclick="window.location.href='/dashboard/users?status=officer'"
                                data-bs-toggle="tooltip"
                                data-bs-original-title="Number of users with active 'Dean' status.">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            <div
                        ...
                        <div class="col-6 col-lg-3 col-md-6">
                            <a style="cursor: pointer" onclick="window.location.href='/dashboard/users?status=student'"
                                data-bs-toggle="tooltip"
                                data-bs-original-title="Number of users with active 'student' status.">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            <div
                    ...
                    <div class="row user-select-none">
                        <div class="col-6 col-lg-3 col-md-6">
                            <a style="cursor: pointer" onclick="window.location.href='/dashboard#'" data-bs-toggle="tooltip"
                                data-bs-original-title="The total number of Complaint that have been made by the 'student'.">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            <div
                        ...
                        <div class="col-6 col-lg-3 col-md-6">
                            <a style="cursor: pointer" onclick="window.location.href='/dashboard#'"
                                data-bs-toggle="tooltip"
                                data-bs-original-title="The total number of responses that have been made by 'officers' or 'students' to a Complaint (system's responses included).">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            <div
                        ...
                        <div class="col-6 col-lg-3 col-md-6">
                            <a style="cursor: pointer" onclick="window.location.href='/dashboard/comments'"
                                data-bs-toggle="tooltip"
                                data-bs-original-title="The total number of comments that have been made by all users regarding a confession.">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            <div
                        ...
                        <div class="col-6 col-lg-3 col-md-6">
                            <a style="cursor: pointer" onclick="window.location.href='/dashboard#stat-log-in'"
                                data-bs-toggle="tooltip"
                                data-bs-original-title="The number of logged-in histories made by all users.">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            <div
                ...
                <div class="col-12 col-lg-3">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center">Latest Complaint</h4>
                        </div>
                            ...
                            @empty
                                <div class="recent-message d-flex px-4 py-3">
                                    <div class="alert alert-warning" role="alert">
                                        <h4 class="alert-heading">No acknowledgement</h4>
                                    </div>
                                </div>
                            @endforelse
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @empty
                                <div class="alert alert-warning" role="alert">
                                    <h4 class="alert-heading">No response</h4>
                                    <p>There has been no response from related parties.</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
