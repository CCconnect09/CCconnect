                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($comment->privacy === 'public')
                                            <span class="badge bg-light-warning">Public</span>
                                        @elseif ($comment->privacy === 'anonymous')
                                            <span class="badge bg-light-dark">Anonymous</span>
                                        @endif
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            @if ($comment->id_user === $userData->id_user)
                                                <div class="me-2">
                                                    <a data-bs-toggle="tooltip"
                                                        data-bs-original-title="Make edits to your comments."
                                            ...
                                            <div class="me-2">
                                                <a data-bs-toggle="tooltip"
                                                    data-bs-original-title="Details of a comment."
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <div class="me-2">
                                                <a data-bs-toggle="tooltip"
                                                    data-bs-original-title="Details of your comments."
                                                    href="/confessions/{{ $comment->confession->slug }}/comments/create?comment={{ base64_encode($comment->id_confession_comment) }}&page={{ $comment->page }}"
                                                    class="btn btn-info px-2 pt-2">
                                                    <span class="fa-fw fa-lg select-all fas"></span>
                                                </a>
