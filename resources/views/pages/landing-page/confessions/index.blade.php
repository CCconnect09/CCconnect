    ...
    <section class="container px-4">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 mb-3 header-about mt-3">
                        ...
                        <p class="text-subtitle text-muted">
                           List of all acknowledgments that have been made by the student.
                        </p>
                        <hr>
                    </div>
                            ...
                            <form action="/confessions">
                                ...
                                @if (count(request()->all()) === 1 && array_key_exists('page', request()->all()))
                                    <div class="mb-3 text-center d-none">
                                        <a class="btn btn-color text-white">No filters</a>
                                    </div>
        ...
        <div class="page-content">
            ...
            <div class="row">
                                                ...
                                                <div>
                                                    <form action="/confessions/{{ $confession->slug }}/like-dislike"
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            <span class="d-none d-sm-inline">Criticism</span>
                                                        </button>
                                                    </form>
                                                </div>
                                                <div>
                ...
                @empty
                    <div class="my-5">
                        <h3 class="text-center ">No acknowledgment </h3>
                    </div>
                @endforelse
            </div>
