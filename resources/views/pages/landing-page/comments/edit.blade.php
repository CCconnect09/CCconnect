                ...
                <div class="row justify-content-center">
                    <div class="col-12 mb-3 header-about mt-3">
                        ...
                        <p class="text-subtitle text-muted">
                            Make edits to the comments you have made.
                        </p>
                        <hr>
                        <div class="mb-3">
...
Return to previous page."
                            ...
                            <a data-bs-toggle="tooltip" data-bs-original-title="Unsend the comment you have given."
                                    ...
                                    <div class="col-12 mb-1">
                                        <div class="form-group mandatory @error('comment'){{ 'is-invalid' }}@enderror">
                                            <div class="position-relative">
                                                <label class="form-label">Comment Contents</label>
