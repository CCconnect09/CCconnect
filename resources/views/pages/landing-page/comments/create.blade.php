            ...
            <section class="section">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title d-inline-block">Complaint</h3> <small
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-md-flex justify-content-center">
                            ...
                            <div class="me-4">
                                ...
                                <p>
                                    <span class="fw-bold me-1">Edit</span>
                                            ...
                                            <div class="text-start pe-4">
                                                ...
                                                @if ($comment->id_user === $userData->id_user)
                                                    <div
                                                        ...
                                                        <div class="btn-group">
                                                            <div class="me-2">
                                                                <a data-bs-original-title="Edit your comment."
                                                            ...
                                                            <div class="me-2">
                                                                <a data-bs-toggle="tooltip"
                                                                    data-bs-original-title="Unsend the comment you have given."
...
Unsend the supporting files that you have provided."
                        ...
                        @empty
                            <div class="alert alert-warning" role="alert">
                                <h4 class="alert-heading">
                                    No comment</h4>
                                <p> There are no comments from anyone yet.</p>
                            </div>
                        @endforelse
                    </div>
                </div>
